...
df = pd.read_excel("/... FILE PATH of PITCH INFO .../Pitch coordinates.xlsx")
...
for Players in range (0,12):
    SSG6v6_10Hz.iloc[0:, Players] = signal.savgol_filter(SSG6v6_10Hz.iloc[0:, Players], window_length = 7, polyorder = 1)
